...
- [ ] 6. Agent interface and base infrastructure
  - [ ] 6.1 Define `Agent` interface and create `SpringAiConfig` in `com.healthcare.navigator.agent` and `com.healthcare.navigator.config`
